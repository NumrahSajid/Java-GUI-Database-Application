 ...
 * @author Nimra Sajid
 */
public class ExistingBikes1 extends javax.swing.JFrame {

    /**
     * Creates new form ExistingBikes
     */
    public ExistingBikes1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExistingBikes1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExistingBikes1().setVisible(true);
            }
        });
    }
